...
/**
 * Configuración de Spring Security para ms-modelo.
 */
@Configuration
@EnableWebSecurity
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.PUT, "/api/v1/modelos/**").hasAnyRole("Administrador")
                .requestMatchers(HttpMethod.DELETE, "/api/v1/modelos/**").hasAnyRole("Administrador")
