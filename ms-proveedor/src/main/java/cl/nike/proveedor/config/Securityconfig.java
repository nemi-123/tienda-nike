package cl.nike.proveedor.config;
...
/**
 * Configuración de Spring Security para ms-proveedor.
 */
@Configuration
@EnableWebSecurity
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.PUT, "/api/v1/proveedores/**").hasAnyRole("Administrador")
                .requestMatchers(HttpMethod.DELETE, "/api/v1/proveedores/**").hasAnyRole("Administrador")
