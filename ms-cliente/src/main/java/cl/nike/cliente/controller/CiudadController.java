...
import cl.nike.cliente.service.CiudadService;
...
public class CiudadController {
    ...
    @GetMapping
    @Operation(summary = "Obtener todas las ciudades", description = "Retorna una lista con todas las ciudades registradas")
    public ResponseEntity<List<CiudadResponse>> findAll() {
        return ResponseEntity.ok(ciudadService.findAll());
    }

    @GetMapping("/{id}")
    @Operation(summary = "Obtener ciudad por ID", description = "Busca una ciudad específica por su identificador")
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "Eliminar ciudad", description = "Elimina un registro de ciudad mediante su ID")
